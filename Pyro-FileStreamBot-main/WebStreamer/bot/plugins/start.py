...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        get_msg = await b.get_messages(chat_id=PeerChannel(Var.BIN_CHANNEL), message_ids=int(usr_cmd))
        ...
        stream_link = "https://{}/{}".format("17b94c9b70b5.ngrok.io", get_msg.message_id) if Var.ON_HEROKU or Var.NO_PORT else \
            "http://{}/{}".format("17b94c9b70b5.ngrok.io",
                                     get_msg.message_id)
